		...
		if imgui.Button(u8'Удалить', imgui.ImVec2(100, 25)) then
			...
			if doesFileExist(fpath) then
				...
				if f then
					...
					sampAddChatMessage(u8'[Connect-Tool]: Что-то пошло не так :(', -1)
				end
			else
				sampAddChatMessage(u8'[Connect-Tool]: Что-то пошло не так :(', -1)
			end
	...
	if gadd_window.v then
		...
		if gen == true then
			...
			if imgui.Button(u8'Добавить') then
				...
				sampAddChatMessage('[Connect-Tool]: {FFFFFF}Код успешно сохранён', 0xF1CB09)
				autosave()
			end
			else
...
function mainwindow()
	...
	if vkladki[1] == true then -- Менеджер аккаунтов
		...
		if imgui.Button(fa.ICON_USER_PLUS.. u8'  Добавить', imgui.ImVec2(110, 27)) then
			...
			if doesFileExist(fpath) then
				...
				if f then
					...
					sampAddChatMessage('[Connect-Tool]: Что-то пошло не так :(', -1)
				end
			else
				sampAddChatMessage('[Connect-Tool]: Что-то пошло не так :(', -1)
			end
		...
		if imgui.Combo('##serv', srvn, srv, -1)then
	...
	if vkladki[4] == true then -- Настройки
		...
		if imgui.Combo('##theme', tema, items, -1)then
		...
		imgui.PushItemWidth(150)
		if imgui.Combo('##style', style, styles, -1)then

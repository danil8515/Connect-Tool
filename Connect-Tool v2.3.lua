...
function imgui.OnDrawFrame()
	...
	if changelog_window.v then
		...
		imgui.BeginGroup()
			...
			imgui.Separator() imgui.NewLine() imgui.NewLine() imgui.SameLine(170)
			imgui.Text(u8'V 2.3') imgui.NewLine() imgui.NewLine()
			imgui.SameLine(15) imgui.Text(u8'1. Фикс бага с Анти-Голодом.') imgui.NewLine() imgui.NewLine()
			imgui.SameLine(15) imgui.Text(u8'2. Задержка в реконнекте теперь сохраняется.') imgui.NewLine() imgui.NewLine()
		imgui.EndGroup()

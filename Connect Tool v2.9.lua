...
function main()
	...
	downloadUrlToFile("https://api.kscripts.ru/getlistservers.php", "moonloader/config/KopnevScripts/servers.ctool")
...
if limgui then
	...
	function onReceivePacket(id)
		if reconifkick.v == true and (id == 32 or id == 33 or id == 37 or id == 36) then
			lua_thread.create(function()
	...
	function imgui.OnDrawFrame()
		...
		if changelog_window.v then
			...
			imgui.BeginGroup()
				...
				imgui.Separator() imgui.NewLine() imgui.NewLine() imgui.SameLine(170)
				imgui.Text(u8'V 2.8 - 2.88') imgui.NewLine() imgui.NewLine()
				imgui.SameLine(15) imgui.Text(u8'1. Фикс багов и оптимизация.') imgui.NewLine() imgui.NewLine()
			imgui.EndGroup()

...
function sampev.onServerMessage(color,text)
	if f_scrText_state and (altbot or animsbot or chipsbot or fishbot or venisonbot or venisonbotbag) then
	...
	function imgui.OnDrawFrame()
		...
		if changelog_window.v then
			...
			imgui.BeginGroup()
				...
				imgui.Separator() imgui.NewLine() imgui.NewLine() imgui.SameLine(170)
				imgui.Text(u8'V 2.6') imgui.NewLine() imgui.NewLine()
				imgui.SameLine(15) imgui.Text(u8'1. Добавлена возможность есть оленину из мешка (Анти-Голод).') imgui.NewLine() imgui.NewLine()
				imgui.SameLine(15) imgui.Text(u8'2. Добавлена функция "Умная установка".') imgui.NewLine() imgui.NewLine()
				imgui.SameLine(15) imgui.Text(u8'3. Добавлено новогоднее настроение. Его нет, но оно есть ') imgui.NewLine() imgui.NewLine()
				imgui.SameLine(15) imgui.Text(u8'4. При режиме Невидимки сообщения идут в консоль ') imgui.NewLine() imgui.NewLine()
				imgui.SameLine(15) imgui.Text(u8'   Первая строчка не поместилась? Да и хрен с ней ') imgui.NewLine() imgui.NewLine()
			imgui.EndGroup()
